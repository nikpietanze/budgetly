        ...
        <nav class="navbar bg-base-100 border-b border-slate-700">
            <div class="navbar-start">
                <div class="dropdown">
                    ...
                    <ul tabindex="0" class="menu menu-normal dropdown-content mt-3 p-2 shadow-lg bg-base-100 rounded-lg w-52">
                        <li><a href="/">Home</a></li>
                    </ul>
                </div>
            </div>
            ...
            <div class="navbar-end">
                ...
                <div class="dropdown dropdown-end">
                    <label tabindex="0" class="btn btn-ghost btn-circle flex justify-center items-center">
                        <Show
                            when={!loading() && user()}
                            fallback={<img class="rounded-full shadow shadow-stone-900 h-10 w-10" src="" />}
                        >
